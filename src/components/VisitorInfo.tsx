...
const whatsappLink = 'https://wa.me/260978534205';
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-24">
          <div className="lg:col-span-6">
            <motion.p
              ...
              className="text-[11px] font-semibold uppercase tracking-overline text-gold"
            >
              Visitor information
            </motion.p>
            ...
            <motion.h2
              ...
              className="mt-7 font-display text-[2.6rem] font-medium leading-[1.06] tracking-[-0.015em] text-ink sm:text-[3.4rem]"
            >
              Reserve a room
            </motion.h2>
            ...
            <motion.p
              ...
              className="mt-7 max-w-md text-[15px] font-light leading-[1.85] text-ink-muted"
            >
              Rooms are booked directly with the front desk. WhatsApp us to
              confirm rates, availability and arrival times.
            </motion.p>
